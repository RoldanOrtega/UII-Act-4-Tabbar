...
class SuspensoTab extends StatelessWidget {
  const SuspensoTab({super.key});
  @override
  Widget build(BuildContext context) {
    return _buildLayout('https://raw.githubusercontent.com/RoldanOrtega/UII-Act-4-Tabbar/refs/heads/main/suspenso.JPG', "Misterio Absoluto");
  }
