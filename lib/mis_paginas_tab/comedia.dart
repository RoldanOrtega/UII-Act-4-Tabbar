...
class ComediaTab extends StatelessWidget {
  const ComediaTab({super.key});
  @override
  Widget build(BuildContext context) {
    return _buildLayout('https://raw.githubusercontent.com/RoldanOrtega/UII-Act-4-Tabbar/refs/heads/main/comedia.JPG', "Risas Aseguradas");
  }
