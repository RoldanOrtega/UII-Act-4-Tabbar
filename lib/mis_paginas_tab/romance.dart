...
class RomanceTab extends StatelessWidget {
  const RomanceTab({super.key});
  @override
  Widget build(BuildContext context) {
    return _buildLayout('https://raw.githubusercontent.com/RoldanOrtega/UII-Act-4-Tabbar/refs/heads/main/romance.JPG', "Historias de Amor");
  }
